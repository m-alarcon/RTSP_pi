...
//char const* inputFileName = "kk.bin";
...
int main(int argc, char** argv) {
  ...
  const unsigned estimatedSessionBandwidth = 5000000; // in kbps; for RTCP b/w share
  ...
  RTSPServer* rtspServer = RTSPServer::createNew(*env, 8553);
  if (rtspServer == NULL) {
  ...
  *env << "Play this stream using the URL \"" << url << "\"\n";
  ...
  // Start the streaming:
  *env << "Beginning streaming in " << waitTime << " seconds...\n";
  sleep(waitTime);
  play();
